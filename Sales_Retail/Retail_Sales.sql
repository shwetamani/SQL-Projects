...
-- Q.3 Write a SQL query to calculate the total sales (total_sale) and for each category.
...
SELECT category, gender,COUNT(transaction_id)as net_transactions
FROM retail_sales
GROUP BY 1,2
ORDER BY 1,2
...
-- Q.9 Write a SQL query to find the number of unique customers purchased items from each category.
